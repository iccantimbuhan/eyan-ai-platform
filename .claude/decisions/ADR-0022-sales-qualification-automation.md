...
- `.claude/decisions/ADR-0018-crm-foundation.md` (pipeline-stage-single-authority precedent, Decision 5)
- `.claude/decisions/ADR-0019-automation-integration-contract.md` (webhook dispatch pattern, "new event not new dispatcher")
