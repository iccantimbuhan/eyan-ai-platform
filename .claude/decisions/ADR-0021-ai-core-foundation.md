...
- `.claude/decisions/ADR-0001-single-ai-provider-no-gateway.md` (superseded for text/chat generation by this ADR)
- `.claude/decisions/ADR-0012-mcp-foundation.md` (the architectural shape this module mirrors)
- `.claude/decisions/ADR-0020-ai-provider-contract.md` (Decisions 2, 5, 6, 7, 8 generalized here)
- `.claude/decisions/ADR-0018-crm-foundation.md`, `.claude/decisions/ADR-0019-automation-integration-contract.md` (the CRM/automation context this module generalizes from)
