          ...
          <section>
            ...
            {healthLoading ? (
              ...
              <div className='flex flex-wrap gap-3'>
                ...
                <StatusBadge
                  status={
                    modelsLoading || modelsError ? 'warning' : 'connected'
                  }
                  label={
                    modelsLoading
                      ? 'Loading models...'
              ...
              <StatCard
                ...
                value={
                  healthLoading ? (
                    ...
                    health.provider.charAt(0).toUpperCase() +
                    health.provider.slice(1)
                  ) : (
                    '—'
                  )
                }
                description={
                  healthError ?? health?.model ?? 'No model configured'
                }
                icon={<Server />}
              />
              <StatCard
