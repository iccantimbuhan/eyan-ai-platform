...
export function PlaygroundPage() {
  ...
  const [targetMode, setTargetMode] = useState<
    (typeof TARGET_MODE)[keyof typeof TARGET_MODE]
  ...
  async function run() {
    try {
      ...
      const response = await invoke.mutateAsync({
        capabilityKey:
          targetMode === TARGET_MODE.CAPABILITY ? targetKey : undefined,
  ...
  return (
    <Main className='space-y-6'>
      <PageHeader
        title='Playground'
        description='Execute a Capability or Brain with optional provider/model/prompt overrides. Never modifies production routing; excluded from usage/cost reporting.'
        breadcrumbs={[
      ...
      <div className='grid gap-6 lg:grid-cols-2'>
        <div className='space-y-4 rounded-lg border p-4'>
          <div className='grid gap-4 sm:grid-cols-2'>
            <div className='space-y-2'>
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value={TARGET_MODE.CAPABILITY}>
                    Capability
                  </SelectItem>
                  <SelectItem value={TARGET_MODE.BRAIN}>
                    Brain (admin)
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className='space-y-2'>
              <Label>
                {targetMode === TARGET_MODE.CAPABILITY ? 'Capability' : 'Brain'}
              </Label>
              <Select value={targetKey} onValueChange={setTargetKey}>
                ...
                <SelectContent>
                  {(targetMode === TARGET_MODE.CAPABILITY
                    ? capabilities
                    : brains
                  ).map((item) => (
            ...
            <div className='mt-3 grid gap-3 sm:grid-cols-3'>
              <div className='space-y-2'>
                ...
                <Select
                  ...
                  onValueChange={setOverrideProviderId}
                >
                  <SelectTrigger className='w-full'>
              ...
              <div className='space-y-2'>
                ...
                <Select
                  ...
                  onValueChange={setOverrideModelId}
                >
                  <SelectTrigger className='w-full'>
                    <SelectValue placeholder='Default' />
                  </SelectTrigger>
              ...
              <div className='space-y-2'>
                ...
                <Input
                  placeholder='e.g. v2'
                  value={overridePromptVersion}
                  onChange={(event) =>
                    setOverridePromptVersion(event.target.value)
                  }
                />
              </div>
            </div>
          ...
          <Button
            onClick={run}
            disabled={invoke.isPending || !targetKey}
            className='w-full'
          >
        ...
        <div className='space-y-4 rounded-lg border p-4'>
          ...
          {!result && (
            <p className='text-sm text-muted-foreground'>
              Run an execution to see the structured output and raw response
              here.
            </p>
          )}
          {result && (
            <div className='space-y-3'>
              <div className='flex flex-wrap gap-2'>
                ...
                {result.needsManualReview && (
                  <Badge variant='destructive'>Needs Manual Review</Badge>
                )}
