...
// text-to-image via Inference Providers (see
...
// text-to-image model available through Inference Providers works by
// setting HUGGINGFACE_MODEL; this provider never assumes a specific one is
// available on the configured account, or on any single named provider
// partner (see HUGGINGFACE_PROVIDER, default "auto", in env.ts).
