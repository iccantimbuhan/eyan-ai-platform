...
import inventoryItemsRoutes from "./routes/v1/inventory-items.routes.js";
import salesRoutes from "./routes/v1/sales.routes.js";
...
app.use("/api/v1/inventory-items", inventoryItemsRoutes);
